...
memory(CONTROL_BUFFER,'w',0xAA,'k');                                  // Palavra de controle habilitando a leitura do PRU_BUFFER por parte da PRU
while(memory(CONTROL_BUFFER,'r',0x00,'o')!=0xCC);                     // Aguarda a escrita no ARM_BUFFER por parte da PRU
